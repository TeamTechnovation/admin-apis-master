CREATE OR REPLACE function GetAllProductByRestaurant(restaurantid int)
returns table(
	"id" integer,
...
drop FUNCTION GetAllProductByRestaurant(restaurantid int)

select * from GetAllProductByRestaurant(89)
